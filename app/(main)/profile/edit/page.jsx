  ...
  return (
    <>
      <main className="lg:pt-[66px] bg-primary w-full">
        <Index />
        <Link href={client_routes.profile} className="hidden fixed z-[1000] bg-secondary top-[96px] right-[40px] xl:right-[72px] h-10 w-10 xl:h-14 xl:w-14 md:flex items-center justify-center rounded-[5px]" data-aos='fade-left'>
