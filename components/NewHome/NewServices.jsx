...
import Img3 from "../../public/assets/genuine-profiles.svg"
...
const NewServices = ({ allStrings }) => {
    const servicesArr = [
        ...
        { id: 4, imgUrl: Img3, title: allStrings["string_successful_dating_online"], description: allStrings["string_succesful_dating_online_description"] },
