    ...
    return (
        <div className='w-full h-full flex flex-col bg-primary 2xl:bg-primary-dark-3 pt-[14px] md:pt-[50px] px-4 md:px-[30px] text-white'>
            ...
            <div className="w-full flex justify-start items-center flex-col h-full overflow-y-auto" style={{ scrollbarWidth: "none" }}>
                ...
                <div>
                    <div className={`flex flex-col mt-5 md:mt-[30px] items-center ${(selectedObj.is_subscribe === 1 && selectedObj.is_subscription_stop === 0 && selectedObj.is_subscription_cancel === 0) || (selectedObj.is_identityverification === "approved") ? "md:items-start" : "md:items-center"}`}>
