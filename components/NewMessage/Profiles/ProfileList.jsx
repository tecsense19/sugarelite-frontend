...
const ProfileList = ({ currentUser, toUser, unReadCount, allUsers, myChats }) => {
    ...
    return (
        <div className='w-full md:w-[350px] lg:w-[400px] bg-primary-dark-3 h-full py-[14px] md:py-[30px]'>
            <TopNav profileList={profiles.sort((a, b) => b.messages.milisecondtime - a.messages.milisecondtime)} />
            <Profiles profileList={profiles.sort((a, b) => b.messages.milisecondtime - a.messages.milisecondtime)} unReadCount={unReadCount} />
        </div>
    )
}
