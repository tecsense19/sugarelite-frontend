                                ...
                                <div key={inx}>
                                    <div className='flex items-end gap-x-2'>
                                        <div className="flex h-10 min-w-10 bg-tinder rounded-full relative">
                                            <Image src={Logo} alt="ELite_Logo" height={40} width={40} priority className="aspect-square m-auto w-[22.5px] h-[27px] object-cover rounded-full pointer-events-none" />
                                        </div>
