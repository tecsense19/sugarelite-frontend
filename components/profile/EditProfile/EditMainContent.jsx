...
const EditMainContent = ({ handleSubmit, control, setValue }) => {
    ...
    return (
        <div className="w-full lg:ml-[350px] 2xl:ml-[400px] text-white mt-[40px] px-[15px] lg:mt-[30px] lg:px-[50px]" >
            <div className="border-white lg:border-b border-opacity-20 lg:pb-[40px]">
            ...
            <div className="border-white lg:border-b border-opacity-20 pt-[40px] lg:pb-[40px]  w-full">
            ...
            <div className="lg:pt-[40px] pb-[50px] ">
