                                            ...
                                            <tr key={inx} className='bg-primary-dark-6 h-[70px] sm:h-[80px] px-10 w-full'>
                                                <td className='text-center h-full items-center '>
                                                    ...
                                                    <div className='sm:hidden flex ms-4 items-center'>
                                                        {item.avatar_url
                                                            ? <Image src={item.avatar_url} alt='' height={50} width={50} className='rounded-full pointer-events-none h-[40px] w-[40px]' />
                                                ...
                                                <td className='text-end pe-4 ps-2 sm:text-center sm:px-2 h-full table-cell sm:hidden'>
                                                    <div className='flex flex-col items-end gap-y-3'>
                                                        ...
                                                        <button className='bg-danger px-3 py-[3px] text-[11px] sm:text-[16px] font-medium rounded-[5px] leading-[20px]' onClick={() => handleSubmit(item.id)}>
                                                            {type === "photo"
                                                                ? "Decline"
                                                                : "Unblock"
                                                            }
