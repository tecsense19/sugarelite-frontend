...
const Buttons_Profile = () => {
    ...
    return (
        <>
            <button onClick={() => requestHandler("send_message")} className='bg-[#3DC73A] w-full md:w-[calc(100%/2-10px)] lg:max-w-[300px] flex justify-center items-center gap-[10px] h-[42px] lg:h-[56px] rounded-[5px]' data-aos='zoom-in'>
            ...
            <button onClick={() => requestHandler("request")} className='bg-secondary w-full md:w-[calc(100%/2-10px)]  lg:max-w-[300px] flex justify-center items-center gap-[10px] h-[42px] lg:h-[56px] rounded-[5px]' data-aos='zoom-in'>
