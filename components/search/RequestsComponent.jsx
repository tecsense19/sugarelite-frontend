...
// import No_Request from "/public/assets/No_Requests.svg"
...
const RequestsComponent = ({ toggle }) => {
    return (
        <div className={`h-[calc(100%-88px)]  items-center flex-col pt-[10rem] px-4 w-full ${!toggle ? "hidden" : "flex"}`}>
            ...
            <p className='px-8 leading-[20px] font-light text-[16px] mt-1 text-white/60 text-center'>Don't worry though, your charm is just waiting for the right match to come along and light up your notifications!<br />✨ Keep shining ✨ </p>
        </div>
    )
}
