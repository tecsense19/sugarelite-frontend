...
const Cards = ({ allUsers, filterHandler }) => {
  ...
  return (
    <>
      ...
      {
        allUsers.length ?
          <div className={`bg-primary max-h-full h-fit lg:w-[calc(100%-350px)] xl:w-[calc(100%-350px)] w-full p-4 lg:p-[40px] xl:p-[60px] 2xl:p-[70px] grid grid-cols-2 mb-[20px]  xl:grid-cols-3 2xl:grid-cols-4 gap-[16px] lg:gap-[30px] overflow-y-auto slide-in-bottom `} style={{ scrollbarWidth: "none" }} data-aos="fade-left">
            {allUsers.length &&
  ...
  //           <div className="text-white border text-[25px] flex items-center justify-center ">
  //             No users found!
  //           </div>
  //         }
  //       </>
