...
const SwipeFilter = () => {
  ...
  return (
    // Filter Section
    <div className="bg-primary-dark-3 h-full max-h-full overflow-y-auto w-[400px] py-10 px-[30px] text-white filter-container" style={{ scrollbarWidth: "none" }} data-aos="fade-right">
