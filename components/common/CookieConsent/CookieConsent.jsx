...
const CookieConsent = () => {
    ...
    return (
        <>
            <div className={`fixed bottom-[-100px] left-0 right-0 z-[1000] bg-[#141414] items-center py-10 px-[120px] ${isModalOpen ? "hidden" : "flex  "} text-white gap-x-10  justify-center w-full slide-top `}>
            ...
            <CookieModal isModalOpen={isModalOpen} />
        </>
    )
}
