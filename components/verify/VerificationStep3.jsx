...
const VerificationStep3 = ({ nextStepHandler, backStepHandler, closeModal, selectedIdentity, handleChange }) => {
  return (
      ...
      {selectedIdentity
        ? <>
          ...
          <div className='mt-4 md:mt-4 text-start text-primary-dark-3 text-[16px] font-normal leading-[25px]'>
            Take a clear photo of the front of your {selectedIdentity}.
          </div>
          ...
          <label className='cursor-pointer w-full' htmlFor='uploadImg'>
            <div className='mt-5 md:mt-7 mb-2 bg-tinder rounded-[5px] h-10 md:h-[56px] text-white flex justify-center items-center text-[18px] font-semibold leading-[20px] w-full'>
              UPLOAD PHOTO
            </div>
          </label>
        </>
